...
func (oiu *OrderItemUpdate) AddProductIDs(ids ...uuid.UUID) *OrderItemUpdate {
...
func (oiu *OrderItemUpdate) RemoveProductIDs(ids ...uuid.UUID) *OrderItemUpdate {
...
// AddProductIDs adds the "product" edge to the Product entity by IDs.
func (oiuo *OrderItemUpdateOne) AddProductIDs(ids ...uuid.UUID) *OrderItemUpdateOne {
...
// RemoveProductIDs removes the "product" edge to Product entities by IDs.
func (oiuo *OrderItemUpdateOne) RemoveProductIDs(ids ...uuid.UUID) *OrderItemUpdateOne {
